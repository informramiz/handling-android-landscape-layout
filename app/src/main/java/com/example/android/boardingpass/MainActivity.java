...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        mBinding.bookingInfo.textViewTerminal.setText(info.departureTerminal);
        mBinding.bookingInfo.textViewGate.setText(info.departureGate);
        mBinding.bookingInfo.textViewSeat.setText(info.seatNumber);
    }
}
